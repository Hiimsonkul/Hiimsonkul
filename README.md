...
- [huggingface/distil-whisper](https://github.com/huggingface/distil-whisper) -  (today)
...
- [THUDM/AgentTuning](https://github.com/THUDM/AgentTuning) - AgentTuning: Enabling Generalized Agent Abilities for LLMs (3 days ago)
